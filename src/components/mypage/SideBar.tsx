...
// export type myPageTabType = 'myInfo' | 'myBoard' | 'myPlan';
const tabArr: { textKo: string; textEn: myPageTabType }[] = [
  { textKo: '개인정보', textEn: 'myInfo' },
  { textKo: '나의글', textEn: 'myBoard' },
  { textKo: '여행일정', textEn: 'myPlan' },
];

const SideBar = ({ curTab, handleTab }: SideBarPropsType) => {
  return (
    <div className=" col-span-1 flex border-l justify-center items-center min-h-[50vh] relative">
